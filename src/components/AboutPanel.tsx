    ...
    <section className="overlay-panel about-panel" role="dialog" aria-modal="true" aria-labelledby="about-title">
      ...
      <div className="about-layout">
        <div className="about-intro">
          <p>光室是一座只展示繪畫與攝影的純前端數位畫廊，透過三間博物館 API 載入至少一千件公共領域／CC0 作品。雕塑、瓷器、織物、版畫與其他器物會在進入畫廊前被排除。</p>
          <p>本站不裁切、不變形、不以色彩濾鏡改動畫作；一般畫廊與作品全螢幕都會依可用空間等比例放大或縮小。35 件站內繪畫只作首次開啟與跨站影像失敗時的可靠備援，不是館藏上限。</p>
          <p>「輪播模式」由使用者主動開啟，每 6 秒切換一幅作品，可隨時暫停。每件作品都保留作品類型、官方館藏頁、API 與原始影像。</p>
        </div>
        ...
        <div className="about-details">
          <section>
            <h3>影像與授權</h3>
            <p>本展只收錄 API 明確標記為公共領域或 CC0，且作品類型為 Painting／Photograph 的項目。個別作品的類型、授權狀態、署名、原始影像與館藏頁均列於「作品資料與來源」。若官方紀錄後續更新，以官方資料為準。</p>
          </section>
          <section>
            <h3>鍵盤操作</h3>
